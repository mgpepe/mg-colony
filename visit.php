...
<title>Visit Colony - Colony 1209</title>
    ...
    <div class="container">
            ...
            <div class="span10" style="position:relative;height:100px;">
                <nav>
                    <ul>
                        ...
                        <li class="seleccionado">VISIT</li>
                    </ul>
                </nav>
            </div>
        </div>
        <div class="row" id="the-content">
            ...
            <div  class="span12   ">
            	...
            	<div id="visit">
                    <img src="img/pag_contact.png" alt="visit_aptsandlofts" width="765" height="130" border="0" usemap="#Map">
                    <map name="Map">
                      <area shape="rect" coords="3,62,385,98" href="mailto:info@aptsandlofts.com" alt="info_email">
                      <area shape="rect" coords="423,32,763,99" href="http://www.aptsandlofts.com" target="_blank" alt="aptsandlofts_web_site">
                    </map>
                </div>      
            </div>
