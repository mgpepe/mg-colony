<?php $page_title = 'Where is Colony - Colony 1209'; ?>
<?php include ('includes/header.php'); ?>
    ...
    <div class="container">
        ...
        <div class="row" id="the-content">
            ...
            <div  class="span4   ">
		<article> 
        	<div id="redSocial-custom">
				<div id="twitter-custom">
					<a class="twitter-timeline" width="219" height="473" href="https://twitter.com/mgpepe" data-widget-id="359780134150098944" data-chrome="nofooter">Tweets by @BushwickDaily</a>
...
<script>
  ...
  $.backstretch("/img/background_place2.jpg" );
</script>
