...
<script type="text/javascript">
	...
	function inicializoFotos(mb) {
		...
		if (mb > 0) {
			xmlhttp.open("GET","xml/amenties_m.xml",false);
		} else {
			xmlhttp.open("GET","xml/amenties.xml",false);		
		}
...
<body onLoad="inicializoFotos(<?php echo $mobile_browser; ?>); bucle();">
	<div id="content">
		...
		<article>
			...
			<div id="learn">
                <a href="#" id="mostrar" onclick="MM_showHideLayers('mostrar','','hide')">LEARN MORE</a>
                <div id="miTexto">
                    <h1>LOBBY</h1>
                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren </p>
                    <a href="#" class="close" onclick="MM_showHideLayers('mostrar','','show')">HIDE TEXT</a>
                </div>
            </div>
        ...
        <footer>
			...
			<div id="btnFotosFondo">
                ...
                <p id="texto" class="creditos">Acá va el texto</p>
            </div>
		</footer>
